  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-900 text-white">
      <div className="w-full md:w-1/2 flex flex-col justify-center items-start p-8 md:p-12">
        <h1 className="text-3xl md:text-4xl font-bold mb-6">Welcome to <span className="text-blue-200">Smarty Cracks</span></h1>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-12 bg-gray-800">
        {form == "login" ?
